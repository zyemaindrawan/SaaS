        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <p class="text-gray-400 mb-4">
                    {{ $content['company_tagline'] ?? 'Professional company services' }}
                </p>
                ...
                @if(!empty($socialLinks))
                    <div class="flex space-x-4 mt-6">
                        @foreach($socialLinks as $social)
                            <a href="{{ $social['url'] }}" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white transition" title="{{ $social['label'] }}">
