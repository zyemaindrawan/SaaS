    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-3">
                @if($companyLogo)
                    <img src="{{ asset('storage/' . $companyLogo) }}" alt="{{ $companyName }}" class="h-10 w-auto">
                @else
                    <span class="text-2xl font-bold text-gray-800">{{ $companyName }}</span>
                @endif
            </div>
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="#products" class="text-gray-700 hover:text-blue-600 font-medium transition">Products</a>
                <a href="#gallery" class="text-gray-700 hover:text-blue-600 font-medium transition">Gallery</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden pb-4">
            <a href="#home" class="block py-2 text-gray-700 hover:text-blue-600 font-medium">Home</a>
            <a href="#about" class="block py-2 text-gray-700 hover:text-blue-600 font-medium">About</a>
            <a href="#products" class="block py-2 text-gray-700 hover:text-blue-600 font-medium">Products</a>
            <a href="#gallery" class="block py-2 text-gray-700 hover:text-blue-600 font-medium">Gallery</a>
            <a href="#testimonials" class="block py-2 text-gray-700 hover:text-blue-600 font-medium">Testimonials</a>
