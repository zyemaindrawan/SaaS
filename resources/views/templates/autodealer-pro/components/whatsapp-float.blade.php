...
$whatsappMessage = $content['whatsapp_message'] ?? 'Halo, saya ingin info promo dan ketersediaan unit terbaru.';
$whatsappPosition = $content['whatsapp_position'] ?? 'bottom-right';
$whatsappColor = $content['whatsapp_color'] ?? '#25D366';
$whatsappGreeting = $content['whatsapp_greeting_text'] ?? 'Chat sekarang – dapatkan promo spesial!';
@endphp
