            ...
            @foreach($products as $product)
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 transform hover:-translate-y-2">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ $product['link'] }}" class="block w-full text-center bg-honda-red hover:bg-honda-red-dark text-white font-bold py-3 px-4 rounded-lg transition duration-300 shadow-md">
