            ...
            <div class="p-6">
                ...
                <div class="mt-6 pt-4 border-t border-gray-200">
                    <button
                        ...
                        :disabled="loading"
                        class="w-full inline-flex justify-center items-center px-4 py-4 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        ...
                        {{ loading ? 'Memproses...' : (finalTotal > 0 ? 'Buat Website & Bayar Sekarang' : 'Aktivasi Website Gratis') }}
                    </button>
                    <p class="text-xs text-gray-500 text-center mt-2">
                        {{ finalTotal > 0 ? 'Anda akan diarahkan ke halaman pembayaran' : 'Website akan langsung diaktifkan' }}
                    </p>
                </div>
            </div>
        </div>
